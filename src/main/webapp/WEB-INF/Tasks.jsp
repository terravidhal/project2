					...
					<body style="background-color: #d5a6bd;">
						...
						<div class="container mt-4">
							...
							<div class="row justify-content-center">
								<div class="col-sm-10">
									<h5>Project Lead:
										<c:out value="${project.lead.firstName} ${project.lead.lastName}" />
									</h5>
								</div>
							</div>
						</div>
							...
							<div class="row justify-content-center">
								<div class="col-sm-10">
									...
									<form:form action="/projects/${project.id}/tasks" method="POST"
										modelAttribute="taskObj">

										<form:label path="task" style="font-size: 18px;">Add a task ticket for this
											team:</form:label>
										<form:errors path="task" />
										<form:textarea class="form-control" rows="4" path="task" />
						...
						<div class="container mt-3">
							<div class="row justify-content-center">
								<div class="col-sm-10">
									...
									<c:forEach var="elt" items="${project.tasks}">
										<h5 class="me-3 mt-3">
											Added by
											<c:out value="${elt.addedBy.firstName}" /> at
											<fmt:formatDate pattern="hh:mma MMM dd" value="${elt.createdAt}" />
										</h5>
										<p>
											<c:out value="${elt.task}" />
										</p>
									</c:forEach>
								</div>
							</div>
